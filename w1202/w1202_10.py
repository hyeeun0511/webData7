...
# # print(len(asideDiv.find_all("div",{"class":"Component_wrap"})))
#------- 베도
# id:find  여러개:find_all
with open("webtoon_browser.html","r",encoding="utf8") as f:
    soup = BeautifulSoup(f,"lxml")

print(soup.find("span",{"class":"GlobalNavigationBar__lnb_wrap--gyzrj"}).text.strip())
wraps = soup.find_all("div",{"class":"GlobalNavigationBar__item--F7tIS"})
